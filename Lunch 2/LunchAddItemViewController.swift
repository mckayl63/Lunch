...
//  Lunch
//
//  Created by Louise Bishop on 10/03/2015.
...
protocol AddItemViewControllerDelegate : class {
    ...
    //This method will allows us to dismiss our current view controller
...
class LunchAddItemViewController: UIViewController {
    ...
    //We add in a delegate variable with an instance of our delegate, so that we can access its methods inside
    //of our class.
    weak var delegate : AddItemViewControllerDelegate?
    //We add in a property called iconPressed, so we can set the value of our segmented control
    //to it.
    ...
    //MARK: - Save and cancel functions
    ...
    @IBAction func segmentSelected(sender: UISegmentedControl) {
        /*
            ...
            Switch statement must be exhaustive, which means you must provide a response for every
            possible outcome. If thats not appropriate, use a default which appears last
            */

...
class LunchTableViewController: UITableViewController, AddItemViewControllerDelegate {
    ...
    //This function allow us to tell the table view how many rows of data we want to display
    
    //The extra parameter name inside this function is actually the second parameter's external parameter name. This will
    //be used when the function is called.
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // #warning Incomplete method implementation.
        // Return the number of rows in the section.
        
        //Instead of returning a static value such as 1- we want to return the amount of item objects
        //currently inside our array "items"
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        //This line declares our reusable cell. We add in "ItemCell" where it said "reuseIdenfier" so we can tell the tableview to create this kind of cell for each row of data.
        ...
        //Note only use the ! when you definitely know there is a value
        ...
        //We can set this by acccessing imageView's image property
    ...
    func addItemViewControllerDidSave(controller: LunchAddItemViewController, item: Item) {
        ...
        //At the moment we have 2 items in our array, so this is the number that
        //will be returned
        ...
        //We do this after the index path to ensure our row index points to the
        //correct place
        self.items += [item]
        
        //Now add our insertRowAtIndexPath method
        //withRowAnimation allow us to choose which animation style we want the row
        //inserted with, this case .Automatic, .Top etc.
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "AddItem" {
            ...
            //We have to tell Xcode what kind of object is going to be at the
            //end of our segue.
            ...
            //The navigation stack containes views and other navigation controllers. They
            //sit on top of one another. The hierarchy would be as follows:
            ...
            //Xcode can't be sure of what object is sitting on top of the navigation stack,
            ...
            //it's deleate property and set it to ourself.
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if editingStyle == .Delete {
            ...
            //When we delete items from a tableView, we need to make sure that we delete it from
            //our items array too. 
    ...
    //This method allows us to rearrange our tableView cells, but does not change the order of our items
    //in our items array.
